...
export default function Index({
    ...
    const [selectedClient, setSelectedClient] =
        useState<ClientWithCredits | null>(null);
                                                    ...
                                                    <tr key={request.id}>
                                                        ...
                                                        <td className="whitespace-nowrap px-4 py-4">
                                                            ...
                                                            <div className="text-sm text-gray-500">
                                                                {request.package_credit.toLocaleString()}{' '}
                                                                Credits
                                                            </div>
                                                            <div className="text-sm text-gray-500">
                                                                {formatAmount(
                                                        ...
                                                        <td className="space-x-2 whitespace-nowrap px-4 py-4 text-sm font-medium">
                                                            {request.status ===
                                                                'pending' && (
                                                                <>
                                                                    <button
                                                                        ...
                                                                        className="rounded-md bg-green-500 px-3 py-1.5 text-sm text-white hover:bg-green-600 disabled:opacity-50"
                                                                    >
                                                                        {processing ===
                                                                        request.id
                                                                            ? 'Processing...'
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="rounded-md bg-red-500 px-3 py-1.5 text-sm text-white hover:bg-red-600 disabled:opacity-50"
                                                                    >
                                                                        {processing ===
                                                                        request.id
                                                                            ? 'Processing...'
                                ...
                                {creditRequests.last_page > 1 && (
                                    <div className="mt-4 flex items-center justify-between">
                                        <div className="text-sm text-gray-700">
                                            Showing {creditRequests.from} to{' '}
                                            {creditRequests.to} of{' '}
                                            {creditRequests.total} results
                                        </div>
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="p-6">
                                ...
                                <div className="overflow-x-auto">
                                    <table className="min-w-full divide-y divide-gray-200">
                                        ...
                                        <tbody className="divide-y divide-gray-200 bg-white">
                                            {clientsWithCredits.map(
                                                (client) => {
                                                    const recentPurchases =
                                                        client.recent_history.filter(
                                                            (h) =>
                                                                h.type ===
                                                                'purchase',
                                                        ).length;
                                                    ...
                                                    return (
                                                        <tr key={client.id}>
                                                            <td className="whitespace-nowrap px-4 py-4">
                                                                ...
                                                                <span
                                                                    className={`inline-flex rounded-full px-2 text-xs font-semibold leading-5 ${client.active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}
                                                                >
                                                                    {client.active
                                                                        ? 'Active'
                                                                        : 'Inactive'}
                    ...
                    <div className="relative top-20 mx-auto w-11/12 rounded-md border bg-white p-5 shadow-lg md:w-3/4 lg:w-1/2">
                        <div className="mt-3">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm md:grid-cols-4">
                                    <div>
                                        ...
                                        <div className="font-medium">
                                            {formatCredits(
                                                selectedClient.current_credits,
                                            )}
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="font-medium">
                                            {formatCredits(
                                                selectedClient.pending_credits,
                                            )}
                                        </div>
                                    </div>
                                    <div>
                                        ...
                                        <div className="font-medium">
                                            {formatCredits(
                                                selectedClient.total_purchased,
                                            )}
                                        </div>
                                    </div>
                                    <div>
                            ...
                            <div className="max-h-96 overflow-y-auto">
                                ...
                                {selectedClient.recent_history &&
                                Array.isArray(selectedClient.recent_history) &&
                                selectedClient.recent_history.length > 0 ? (
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    <button
                                                        ...
                                                        className="rounded bg-gray-200 px-2 py-1 text-sm text-gray-800 hover:bg-gray-300 disabled:cursor-not-allowed disabled:opacity-50"
                                                        title="First Page"
                                                    >
                                                        <svg
                                                            className="h-4 w-4"
